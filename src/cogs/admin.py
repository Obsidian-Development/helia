...
class Admin(commands.Cog, name="Admin"):
    ...
    async def invite(self, ctx: SlashContext):
        ...
        menu_components = [
            [
                Button(style=ButtonStyle.URL, label=STRINGS["general"]["botinvitetitle"],
        ...
        menuer_components = [
            [
                Button(style=ButtonStyle.URL, label=STRINGS["general"]["botupbod"],
                       url=f"https://bots.ondiscord.xyz/bots/{self.bot.user.id}"),
                Button(style=ButtonStyle.URL, label=STRINGS["general"]["botupdblco"],
