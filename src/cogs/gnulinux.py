...
class gnulinux(commands.Cog):
    ...
    async def ubuntu(self, ctx: SlashContext):  # Ubuntu
        ...
        ubuntu1 = discord.Embed(
            ...
            description=
            "Ubuntu is an operating system based on Debian GNU / Linux. The main developer and sponsor is Canonical. Currently, the project is actively developed and supported by the free community.",
            color=0xDE4714,
        )
        ubuntu1.add_field(
            name="Assesement",
    ...
    async def manjaro(self, ctx: SlashContext):  # Manjaro
        ...
        manjaro1 = discord.Embed(
            ...
            description=
            "Manjaro Linux or Manjaro is an Arch Linux GNU / Linux distribution that uses the rolling release update model. Several versions are officially available: with the XFCE, KDE, or GNOME desktop.",
            color=0x35BF5C,
        )
